        ...
        <main className='w-full bg-slate-50 flex items-start justify-center gap-3 md:p-10 relative flex-col md:flex-row'>
            ...
            <section className='w-full h-32 bg-white shadow-md mt-2 md:hidden'>
                ...
                <div className=' w-full grid grid-cols-6'  >
                    ...
                    <Link href="/account/new-password" className='text-3xl text-Secondary p-1 rounded hover:bg-slate-100 flex justify-center flex-col items-center'>< FiLock /><p className='text-sm'>password</p></Link>
                    <button onClick={signOut}  className='text-3xl text-Secondary p-1 rounded hover:bg-slate-100 flex justify-center flex-col items-center'><FiLogOut /><p className='text-sm' >logout</p></button>
