...
const Bottomnav = () => {
  ...
  return (
    ...
    <Link href="/account/cart"className="flex flex-col items-center justify-center p-2">{location=="/account/carts" ? <RiShoppingCart2Fill/> :<RiShoppingCart2Line/> }<p className="text-sm">Cart</p></Link>
