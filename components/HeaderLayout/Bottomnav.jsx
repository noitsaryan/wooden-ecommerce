...
const Bottomnav = () => {
  ...
  return (
    ...
    <Link href="/"className="flex flex-col items-center justify-center p-2">{location=="/account/carts" ? <RiShoppingCart2Fill/> :<RiShoppingCart2Line/> }<p className="text-sm">Cart</p></Link>
    <Link href="/" className="flex flex-col items-center justify-center p-2">{location=="/account" ? <RiUser3Fill/>: <RiUser3Line/>}<p className="text-sm">Account</p></Link>
  </div>
  )
}
