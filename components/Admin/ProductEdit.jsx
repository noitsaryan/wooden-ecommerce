    ...
    if (newName && newMeasure && newPrice) {
      setData((prevData) => ({
        ...
        variation: {
          ...prevData.variation,
          size: [
            ...prevData.variation.size,
            { name: newName, measure: newMeasure, price: newPrice },
          ],
        },
      }));
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <div className="space-y-2 py-2">
                  ...
                  <Dialog>
                    <DialogTrigger className="bg-black/80 px-4 py-2 mx-2 text-white rounded-md ">
                      Edit Images
                    </DialogTrigger>
                    <DialogContent>
                      <DialogHeader>
                          ...
                          <div className="flex space-x-2 items-center">
                            <Input
                              ...
                              onChange={(event) =>
                                setInput((prevInput) => ({
                                  ...prevInput,
                                  newSpecName: event.target.value,
                                }))
                              }
                            ...
                            <Input
                              ...
                              onChange={(event) =>
                                setInput((prevInput) => ({
                                  ...prevInput,
                                  newSpecValue: event.target.value,
                                }))
                              }
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <div className="space-y-2">
                          {data &&
                            data.variation.color.map((e, i) => (
                              <Input
                                value={e}
                                key={i}
                                onChange={(change) => changeColor(change, i)}
                              />
                            ))}
                  ...
                  <Button
                    ...
                    className="block w-full border bg-transparent hover:bg-black text-black hover:text-white "
                  >
                    Update
                  </Button>
                </div>
